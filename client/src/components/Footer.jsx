...
// } from "react-icons/fi";
// import {
//   FaFacebookF, FaInstagram, FaYoutube, FaWhatsapp, FaXTwitter,
...
//   { label: "WhatsApp",  href: "https://wa.me/919876543210", icon: FaWhatsapp },
...
//   email:   "seva@adiyogifoundation.org",
//   address: "Pilkhua, Hapur, Uttar Pradesh — 245304",
// };
...
//           color: #1E293B;
//           margin-bottom: 20px;
//           /* subtle amber underline accent — matches site's gradient lines */
//           display: inline-flex;
...
//         /* brand name — Cormorant to match site display font */
//         // .ft-brand-name {
...
//         /* ── body copy — matches site's 13-14px body ── */
//         .ft-body {
//           font-size: 13.5px;
//           line-height: 1.78;
//           color: #64748B;
...
//         /* ── donate CTA ── matches site's amber gradient btn ── */
//         .ft-donate-btn {
...
//           gap: 10px;
//         }
//         @media (max-width: 1023px) { .ft-trust-grid { grid-template-columns: repeat(2, 1fr); } }
//         @media (max-width: 480px)  { .ft-trust-grid { grid-template-columns: 1fr; } }
...
//         /* ── spiritual tagline — uses Cormorant ── */
//         .ft-spiritual-line {
//           font-family: 'Cormorant Garamond', Georgia, serif;
//           font-size: 1.0rem; font-style: italic; font-weight: 500;
...
//         .ft-om-line {
//           flex: 1; height: 1px;
//           background: linear-gradient(to right, transparent, #D81B4A 50%, transparent);
//         }
//         .ft-om-sym {
//           font-family: 'Cormorant Garamond', serif;
//           font-size: 1.1rem; color: #D81B4A; letter-spacing: 0.05em;
//         }
//       `}</style>

//       <footer className="ft-root">
//         {/* decorative orbs — unchanged from original */}
//         <div className="pointer-events-none absolute -left-28 top-10 h-80 w-80 rounded-full bg-[#D81B4A]/6 blur-3xl" />
//         <div className="pointer-events-none absolute -right-24 bottom-24 h-80 w-80 rounded-full bg-[#8AAE3B]/6 blur-3xl" />
//         <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(30,41,59,0.03),transparent_38%)]" />

//         <motion.div
//           className="relative mx-auto max-w-7xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-20"
//           initial="hidden"
//           whileInView="visible"
...
//                 className="inline-flex items-center justify-center sm:justify-start gap-3"
//               >
//                 <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white shadow-[0_16px_40px_rgba(216,27,74,0.12)] flex-shrink-0">
//                   <img src={logo} alt="Adiyogi Foundation logo" className="h-9 w-9 object-contain" />
//                 </span>
//                 <span>
...
//             {/* Col 2 — Quick Links */}
//             <motion.nav variants={fadeUp} aria-label="Footer quick links">
//               <span className="ft-col-heading">Quick Links</span>
//               <ul className="space-y-3 flex flex-col items-center sm:items-start mt-1">
//                 {quickLinks.map(link => (
//                   <li key={link.href}>
...
//               <div className="space-y-4 flex flex-col items-center sm:items-start mt-1">
//                 <a href={`tel:${contact.phone}`} className="ft-contact-link">
//                   <FiPhone size={15} className="ft-contact-icon" style={{ color: "#8AAE3B" }} />
//                   <span>{contact.phone}</span>
//                 </a>
//                 <a href={`mailto:${contact.email}`} className="ft-contact-link">
//                   <FiMail size={15} className="ft-contact-icon" style={{ color: "#E8B21C" }} />
//                   <span>{contact.email}</span>
//                 </a>
//                 <div className="ft-contact-link" style={{ cursor: "default" }}>
//                   <FiMapPin size={15} className="ft-contact-icon" style={{ color: "#D81B4A" }} />
...
//                   whileTap={{ scale: 0.97 }}
//                 >
//                   <FiHeart size={14} className="ft-donate-heart" />
//                   Donate Now
...
//           {/* ── Om decorative strip ── */}
//           {/* <div className="ft-om-strip">
//             <div className="ft-om-line" />
//             <span className="ft-om-sym">ॐ नमः शिवाय</span>
//             <div className="ft-om-line" />
//           </div> */}
          ...
          <div className="ft-grid">
            ...
            <motion.div variants={fadeUp} className="ft-grid-item">
              ...
              <div className="ft-contact-list mt-1">
                ...
                <div className="ft-contact-link" style={{ cursor: "default" }}>
                  <FiMapPin size={14} className="sm:w-[15px] sm:h-[15px] ft-contact-icon" style={{ color: "#D81B4A" }} />
                  <span>{contact.address}</span>
                </div>
              </div>
            </motion.div>
