...
//           padding: 0 0;
//         }
//         @media (max-width: 900px)  { .carousel-viewport { height: 360px; } }
//         @media (max-width: 600px)  { .carousel-viewport { height: 280px; } }
...
//           flex-shrink: 0;
//         }
//         @media (max-width: 768px) { .card-center { width: 72%; border-radius: 18px; } }
//         @media (max-width: 480px) { .card-center { width: 82%; border-radius: 14px; } }
...
//           .card-side { width: 12%; top: 12%; height: 76%; }
//           .card-side.prev { left: 1%; }
//           .card-side.next { right: 1%; }
//         }
...
//         }
//         @media (max-width: 600px) { .center-label-wrap { padding: 18px 16px 20px; } }
//         .center-sub {
...
//           text-align: center;
//           font-family: var(--display);
//           font-size: 0.85rem; font-style: italic; font-weight: 600;
...
//         }
//         .hero-dot.on  { width: 30px; background: var(--primary); }
...
//           margin-top: 28px; line-height: 0; overflow: hidden;
//         }
...
//         .trust-sep { width: 1px; height: 16px; background: #e2e8f0; flex-shrink: 0; }
...
//               <div className="center-accent-bar" />
...
//                   <span className="center-label">{slides[active]?.label}</span>
//                 </motion.div>
//               </AnimatePresence>
//             </div>
...
//             <span className="trust-item"><FiShield size={13} className="ti-green" />Secure &amp; Encrypted Giving</span>
//             <div className="trust-sep" />
//             <span className="trust-item"><FiUsers size={13} className="ti-red" />12,400+ Lives Touched</span>
//             <div className="trust-sep" />
//             <span className="trust-item"><FiShield size={13} className="ti-red" />NGO Darpan · FCRA Certified</span>
//           </div>
//         </div>
//       </section>
//     </>
      ...
      <section className="hero-wrap">
        ...
        <div className="hero-below">
          <div className="trust-strip">
            ...
            <div className="trust-sep" />
            <span className="trust-item"><FiUsers size={11} className="sm:w-[12px] sm:h-[12px] lg:w-[13px] lg:h-[13px] ti-red" />12,400+ Lives Touched</span>
            <div className="trust-sep" />
            <span className="trust-item"><FiShield size={11} className="sm:w-[12px] sm:h-[12px] lg:w-[13px] lg:h-[13px] ti-red" />NGO Darpan · FCRA Certified</span>
          </div>
        </div>
      </section>
    </>
