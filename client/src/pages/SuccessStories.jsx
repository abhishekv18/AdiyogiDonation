...
const stories = [
  {
    ...
    title: "Maha Anna Seva: 51,000 Pilgrims Fed in a Single Day",
    location: "Ramkund, Nashik",
    summary:
      "During the grand Shahi Snan, our volunteers served hot, nutritious meals to 51,000 pilgrims who had traveled from across Bharat for the holy dip. The queue stretched for kilometers, but no one left hungry.",
    impact: "51,000+ meals served",
    img: "/Gemini_Generated_Image_kaz8sckaz8sckaz8.png",
    quote: "Bhojan se badhkar koi daan nahi. Annadaan hi mahadaan hai.",
    quoteName: "Swami Dayanand Saraswati",
  },
  {
    id: 2,
    category: "Anna Seva",
    categoryColor: "#8AAE3B",
    title: "Night Seva: Feeding the Aghori Sadhus",
    location: "Tapovan, Nashik",
    summary:
      "Aghori sadhus, the fierce ascetics who come to Kumbh only at night, were served simple khichdi and chai with deep reverence. Our volunteers sat in silence, understanding that these souls carry ancient wisdom.",
    impact: "1,200 sadhus served",
    img: "/Gemini_Generated_Image_byfe69byfe69byfe.png",
    quote: "In the silence of the night, we found the loudest prayers.",
    quoteName: "Volunteer, Night Seva Dal",
  },
  {
    id: 3,
    category: "Anna Seva",
    categoryColor: "#E8B21C",
    title: "Neelmani Anna Kshetra: 40 Days of Continuous Seva",
    location: "Near Trimbakeshwar Road, Nashik",
    summary:
      "Our massive community kitchen operated 24 hours a day for 40 consecutive days. Pilgrims, saints, and the needy — all were welcomed with folded hands and a warm plate. The langar never stopped.",
    impact: "2.8 Lakh+ meals",
    img: "/Gemini_Generated_Image_td8v7itd8v7itd8v.png",
    quote: "This is not a kitchen — it is a mandir of compassion.",
    quoteName: "Mohan Das, Local Priest",
  },
  {
    id: 4,
    category: "Anna Seva",
    categoryColor: "#D81B4A",
    title: "Gau Seva & Anna: Feeding the Sacred Cows",
    location: "Gau Shala, Panchavati, Nashik",
    summary:
      "Beyond feeding humans, we ensured the sacred Gau Matas were fed fresh rotis, jaggery, and green fodder daily. Thousands of cows found shelter and food during the mela period.",
    impact: "8,000+ gau vansh served",
    img: "/Gemini_Generated_Image_itbttzitbttzitbt.png",
    quote: "Gau seva is the root of all dharma. Where cows are happy, gods reside.",
    quoteName: "Gau Sevak, Adiyogi Foundation",
  },
  {
    id: 5,
    category: "Anna Seva",
    categoryColor: "#8AAE3B",
    title: "Jal Seva & Anna: Quenching Thirst at Godavari Ghats",
    location: "Godavari River Banks, Nashik",
    summary:
      "Under the scorching Nashik sun, we distributed chilled buttermilk, jaljeera, and water to pilgrims waiting hours for their holy dip. Thirst and hunger were vanquished together.",
    impact: "1.5 Lakh+ served",
    img: "/Gemini_Generated_Image_wrnvvqwrnvvqwrnv (1).png",
    quote: "Pyaas aur bhookh — dono ka ant karna hi Kumbh ka asli punya hai.",
    quoteName: "Sevak, Godavari Ghat",
  },
  {
    id: 6,
    category: "Anna Seva",
    categoryColor: "#E8B21C",
    title: "Akharas & the Sacred Food Offering",
    location: "Niranjani Akhara Camp, Nashik",
    summary:
      "We were honored to serve the Naga Sadhus, Mahamandaleshwars, and their disciples with sattvic meals prepared in pure ghee. Every grain was offered to the fire before being served.",
    impact: "12 Akharas served",
    img: "/Gemini_Generated_Image_fc41p6fc41p6fc41.png",
    quote: "To serve the sadhus is to serve Shiva himself. We are blessed.",
    quoteName: "Mahant Ravi Giri, Niranjani Akhara",
  },
];
