...
//         /* brand */
//         .al-brand { display: flex; align-items: center; gap: 12px; text-decoration: none; }
//         .al-brand-logo {
...
//         /* ── layout ── */
//         .al-body { display: flex; min-height: calc(100vh - 72px); padding-top: 72px; }
...
//           margin: 0 auto 28px; color: #FFFFFF;
...
//         }
//         .al-left-sub {
//           font-size: 15px; color: rgba(255,255,255,0.78); line-height: 1.70; margin-bottom: 32px;
//         }
...
//         }
//         .al-feature-body { font-size: 13px; color: rgba(255,255,255,0.72); line-height: 1.60; }

//         /* ── right form panel ── */
//         .al-right {
//           width: 100%; display: flex;
//           align-items: center; justify-content: center;
//           padding: 40px 24px; background: var(--warm);
//         }
...
//           text-align: center; margin-bottom: 32px; line-height: 1.60;
//         }
...
//         }
//         .al-footer-brand { display: flex; align-items: center; gap: 12px; }
//         .al-footer-logo { width: 40px; height: 40px; border-radius: 50%; overflow: hidden; }
...
//                 <Users size={20} className="al-feature-icon" />
//                 <div>
...
//               <div className="al-feature">
//                 <Heart size={20} className="al-feature-icon" />
//                 <div>
...
//                       <ArrowRight size={16} className="al-arrow" />
//                     </>
//                   )}
//                 </button>
//               </form>
