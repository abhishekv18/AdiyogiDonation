...
//   FiX, FiAward, FiUsers, FiTarget, FiMail,  // Added FiMail
// } from "react-icons/fi";
...
//   { _id: "1", name: "Lotus Health Trust",  logo: "https://dummyimage.com/220x70/f8fafc/64748b&text=Lotus+Trust",  website: "#" },
//   { _id: "2", name: "Greenleaf Partners",  logo: "https://dummyimage.com/220x70/f8fafc/64748b&text=Greenleaf",    website: "#" },
//   { _id: "3", name: "Sahas Foundation",    logo: "https://dummyimage.com/220x70/f8fafc/64748b&text=Sahas",        website: "#" },
//   { _id: "4", name: "Aarogya Care",        logo: "https://dummyimage.com/220x70/f8fafc/64748b&text=Aarogya",      website: "#" },
//   { _id: "5", name: "Microsoft",           logo: "https://dummyimage.com/220x70/f8fafc/64748b&text=Microsoft",    website: "#" },
//   { _id: "6", name: "Global Tech",         logo: "https://dummyimage.com/220x70/f8fafc/64748b&text=Global+Tech",  website: "#" },
// ];
...
//           >
//             <FiHeart size={40} className="success-heart" />
//           </motion.div>
...
//   //       if (!alive) return;
//   //       const d = Array.isArray(res.data) ? res.data : res.data?.sponsors || [];
//   //       if (d.length) setSponsors(d);
//   //       else setSponsors(fallbackSponsors);
//   //     } catch { if (alive) setSponsors(fallbackSponsors); }
//   //   })();
//   //   return () => { alive = false; };
//   // }, []);

//   //const visibleSponsors = sponsors.length ? sponsors : fallbackSponsors;
//   useEffect(() => {
//     let alive = true;
...
//       image: "https://ibb.co/tw70Mqm3", // Add your logo URL here
...
//         }
//         @media (max-width: 768px) { .sponsors-block { padding: 40px 20px 36px; } }
...
//           display: grid;
//           grid-template-columns: 1.1fr 4px 1fr;
//           gap: 0 0;
//           align-items: start;
//         }
//         @media (max-width: 1023px) {
//           .sd-lower { grid-template-columns: 1fr; padding: 40px 20px 56px; gap: 48px; }
//         }
...
//           padding-right: 48px;
//         }
//         @media (max-width: 1023px) { .sp-grid { padding-right: 0; } }
...
//           object-fit: contain;
//           // filter: grayscale(1) opacity(0.60);
//           transition: filter 0.3s;
//         }
//         .sp-card:hover .sp-card-img { filter: none; }
//         .sp-card-name {
...
//         }
//         .sp-left-body {
//           font-size: 14px; color: #64748B; line-height: 1.72; margin: 0;
//           max-width: 400px;
//         }
...
//           overflow: hidden;
//         }
//         @media (max-width: 480px) { .donate-card { padding: 24px 18px 24px; } }
...
//         }
//         .donate-sub {
//           font-size: 13.5px; color: #64748B; line-height: 1.65; margin: 0 0 24px;
//         }
...
//           margin-bottom: 14px;
//         }
//         @media (max-width: 360px) { .amounts-grid { grid-template-columns: repeat(2, 1fr); } }
...
//               </p>
//             </div>
//             <SponsorMarquee sponsors={visibleSponsors} />
//           </div>
//         </div>
...
//                 Each sponsor shares our belief that every person deserves dignity,
//                 care, and an opportunity to thrive.
//               </p>
//             </div>
...
//                         {s.name}
//                         {/* {s.website && <FiArrowUpRight size={10} style={{ opacity: 0.5 }} />} */}
//                       </span>
//                     </Wrap>
//                   </motion.div>
//                 );
...
//                 <span className="field-label">
//                   <FiPhone size={12} style={{ display: 'inline', marginRight: '4px' }} />
//                   Phone Number
//                 </span>
//                 <input
...
//                       style={{ width: '16px', height: '16px', border: '2px solid #fff', borderTopColor: 'transparent', borderRadius: '50%' }}
//                     />
//                     Processing...
//                   </>
//                 ) : (
//                   <>
//                     <FiHeart size={16} className="cta-heart" />
//                     Donate Securely
...
//   FiArrowUpRight, FiCheckCircle, FiCreditCard,
//   FiGlobe, FiHeart, FiLock, FiShield, FiUser, FiPhone,
//   FiX, FiAward, FiUsers, FiTarget, FiMail,
// } from "react-icons/fi";
// import toast, { Toaster } from 'react-hot-toast';
// import { ServerUrl } from "../App";
...
//         }
//         @media (min-width: 1024px) {
//           .sp-grid { grid-template-columns: repeat(3, 1fr); padding-right: 48px; }
//         }
...
//         }
//         @media (min-width: 640px) {
//           .sp-card { padding: 18px 12px; border-radius: 16px; gap: 10px; min-height: 106px; }
//         }
//         @media (min-width: 1024px) {
//           .sp-card { padding: 20px 14px; border-radius: 18px; min-height: 110px; }
//         }
//         .sp-card:hover {
//           transform: translateY(-4px);
//           box-shadow: 0 14px 40px rgba(30,41,59,0.09);
...
//         }
//         .sp-card-img {
//           max-height: 30px; max-width: 90px;
//           object-fit: contain;
//           transition: filter 0.3s;
//         }
//         @media (min-width: 640px) {
//           .sp-card-img { max-height: 34px; max-width: 100px; }
//         }
//         @media (min-width: 1024px) {
//           .sp-card-img { max-height: 36px; max-width: 110px; }
//         }
//         .sp-card:hover .sp-card-img { filter: none; }
//         .sp-card-name {
//           font-size: 10.5px; font-weight: 600;
